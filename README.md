...
**Get-Driving** is a professional-grade mobile application designed to help aspiring drivers learn, practice, and connect with top driving instructors.  
The app includes **quiz systems**, **e-learning materials**, and tools to connect learners with certified instructors.  
...
I worked on integrating and improving multiple modules within the Get-Driving app:

- ✅ **Integrated the quiz system** for learners to test their driving knowledge  
- 🎥 **Implemented CGI video flagging** features for content review  
- ▶️ **Integrated custom video player screens** for e-learning videos  
- 🛠️ **Used Hive DB to manage video player data and state**  
- 🎨 **Enhanced layouts, polished UI, and fixed UI inconsistencies**  
...
**App Store:**  
[View it on App Store](https://apps.apple.com/no/app/get-driving-revision-kit-uk/id1661636250)
